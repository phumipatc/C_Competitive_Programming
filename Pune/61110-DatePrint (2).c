...
int main(){
    ...
    while(n--){
        ...
        if(d<1 || d>31 || m<1 || m>12 || y<1000 || y>3000 || p<1 || p>4) printf("No");
            ...
            if(m==1) printf("%02d January, %d",d,y%100);
            else if(m==2) printf("%02d February, %d",d,y%100);
            else if(m==3) printf("%02d March, %d",d,y%100);
            else if(m==4) printf("%02d April, %d",d,y%100);
            else if(m==5) printf("%02d May, %d",d,y%100);
            else if(m==6) printf("%02d June, %d",d,y%100);
            else if(m==7) printf("%02d July, %d",d,y%100);
            else if(m==8) printf("%02d August, %d",d,y%100);
            else if(m==9) printf("%02d September, %d",d,y%100);
            else if(m==10) printf("%02d October, %d",d,y%100);
            else if(m==11) printf("%02d November, %d",d,y%100);
            else if(m==12) printf("%02d December, %d",d,y%100);
        }
